...
:Farbe
cls
echo If you want to have a colored background AND colored letters, enter 1 number and a letter like this:
echo 0d or 6f
echo.
echo.
echo.
echo Background: Black(0), Blue(1), Green(2), Blue-green(3), Red(4), Purple(5), 
echo Orcker(6), HGray(7), DGray(8), Blue(9). 
echo.
echo letters: Green(a), Cyan(b), Red(c), Magenta(d), Yellow(e), White(f).
echo Back to the settings: end
set /p Farbe=Color: 
